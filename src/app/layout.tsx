		...
		<html lang='vi'>
			...
			<body className='bg-gray-50 text-gray-900 font-sans min-h-screen antialiased selection:bg-gray-900 selection:text-white'>
				...
				<header className='bg-white border-b border-gray-200 sticky top-0 z-10'>
					<div className='max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between'>
						...
						<div className='flex items-center gap-3'>
							...
							<h1 className='text-lg font-bold tracking-tight text-gray-900'>Sổ Thu Chi</h1>
						</div>

						{/* Slogan: Thu gọn lại, màu xám nhạt, ẩn trên mobile để đỡ rối */}
						<p className='text-sm text-gray-500 font-medium hidden sm:block'>Quản lý tài chính cá nhân</p>
					</div>
				</header>
				...
				<footer className='bg-white border-t border-gray-200 py-6 text-center'>
					<small className='text-xs font-medium text-gray-400 uppercase tracking-wider'>&copy; {new Date().getFullYear()} Sổ Thu Chi</small>
				</footer>
			</body>
		</html>
	);
